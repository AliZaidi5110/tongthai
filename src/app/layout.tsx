...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      ...
      {
        url: 'https://www.tongthaionline.com/images/photodune-5087439-chicken-tagine-m.jpg',
        width: 1200,
        height: 800,
        alt: 'Authentic Thai cuisine served fresh at TongThai Restaurant Bradford',
      },
    ],
  },
  twitter: {
...
const restaurantSchema = {
  ...
  image: [
    ...
    'https://www.tongthaionline.com/images/photodune-5087439-chicken-tagine-m.jpg',
    'https://www.tongthaionline.com/images/shutterstock_179643251-490x314.jpg',
  ],
