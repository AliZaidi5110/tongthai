...
export default function ChefTeam() {
  return (
    ...
    >
          ...
          {CHEFS.map((chef) => (
            ...
            >
              ...
              <div className="chef-img-square chef-img-wrapper">
                <Image
                  src={chef.image}
                  alt={`${chef.name} - ${chef.role} at TongThai Bradford`}
                  fill
                ...
                {/* Social icons overlay on hover and focus-within */}
                <div
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: '14px' }}>
                    <a
                      ...
                      aria-label={`Follow ${chef.name} on X`}
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Follow ${chef.name} on Facebook`}
                      className="chef-social-icon"
                      style={{
                        width: '38px',
                        height: '38px',
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Follow ${chef.name} on Instagram`}
                      className="chef-social-icon"
                      style={{
                        width: '38px',
                        height: '38px',
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Follow ${chef.name} on LinkedIn`}
                      className="chef-social-icon"
                      style={{
                        width: '38px',
                        height: '38px',
      ...
      <style jsx>{`
        .chef-card:hover,
        .chef-card:focus-within {
          transform: translateY(-6px);
          border-color: var(--color-gold);
        }
        .chef-card:hover .chef-portrait,
        .chef-card:focus-within .chef-portrait {
          transform: scale(1.05);
        }
        .chef-card:hover .chef-social-overlay,
        .chef-card:focus-within .chef-social-overlay {
          opacity: 1;
        }
        .chef-social-icon:hover,
        .chef-social-icon:focus-visible {
